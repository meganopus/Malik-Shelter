...
<template>
  <div class="min-h-screen flex bg-[#F5E6E0]">
    ...
    <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center p-12">
      ...
      <div class="relative z-10 max-w-md">
        ...
        <!-- Description -->
        <p class="text-[#5D5D5D] text-lg leading-relaxed mb-12">
    ...
    <div class="w-full lg:w-1/2 bg-white flex items-center justify-center p-8">
      <div class="w-full max-w-md space-y-8">
        ...
        <div class="text-center">
          <h1 class="text-4xl font-bold text-[#2D2D2D] mb-2">Create your account</h1>
          <p class="text-[#B8936D]">Please fill in your details to get started.</p>
        </div>
        ...
        <form @submit.prevent="handleSubmit" class="space-y-6">
          <!-- Full Name Field -->
          <div>
            <label class="block text-sm font-medium text-[#5D5D5D] mb-2">Full Name</label>
            <div class="relative">
              <div class="absolute left-4 top-1/2 -translate-y-1/2 text-[#B8936D]">
              ...
              <input v-model="fullName" type="text" required placeholder="e.g. Jane Doe"
                class="w-full pl-12 pr-4 py-4 rounded-2xl bg-[#F8F8F8] border-2 border-transparent focus:border-[#B8C9A8] focus:bg-white focus:ring-0 outline-none transition-all text-[#2D2D2D] placeholder:text-[#B8936D]/50" />
            </div>
          </div>

          <!-- Email Field -->
          <div>
            <label class="block text-sm font-medium text-[#5D5D5D] mb-2">Email Address</label>
            <div class="relative">
              <div class="absolute left-4 top-1/2 -translate-y-1/2 text-[#B8936D]">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
          ...
          <!-- Password Field -->
          <div>
            <label class="block text-sm font-medium text-[#5D5D5D] mb-2">Password</label>
            <div class="relative">
              <div class="absolute left-4 top-1/2 -translate-y-1/2 text-[#B8936D]">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <p class="mt-2 text-xs text-[#B8936D]">Must be at least 8 characters long.</p>
          </div>
          ...
          <!-- Terms & Privacy -->
          <p class="text-center text-xs text-[#B8936D]">
            By signing up, you agree to our <a href="#" class="text-[#E8B4A8] hover:underline">Terms</a> and <a href="#"
              class="text-[#E8B4A8] hover:underline">Privacy Policy</a>.
          </p>

          <!-- Login Link -->
          <p class="text-center text-sm text-[#5D5D5D]">
            Already have an account?
            <router-link to="/login" class="text-[#E8B4A8] font-bold hover:underline">Login</router-link>
          </p>
        </form>
      </div>
    </div>
